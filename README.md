...
- memory-game: [View](https://memory-game-lake-psi.vercel.app/) | [Source](https://github.com/AkshayPP-3/Learning-Projects/tree/main/memory-game)

---

Note: the `smartphones-ui` live link opens the standalone demo page in the project folder.
